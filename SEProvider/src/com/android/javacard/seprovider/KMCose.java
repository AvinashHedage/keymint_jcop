...
public class KMCose {
  ...
  public static byte[] COSE_TEST_KEY;
  ...
  //Context strings
  public static  byte[] MAC_CONTEXT;
  public static  byte[] SIGNATURE1_CONTEXT;
  public static  byte[] ENCRYPT_CONTEXT;
  public static  byte[] EMPTY_MAC_KEY;
  ...
  // text strings
  public static  byte[] TEST_ISSUER_NAME;
  public static  byte[] TEST_SUBJECT_NAME;
  public static  byte[] KEY_USAGE_SIGN;
  ...
  public static void initStatics() {
	 ...
	 SIGNATURE1_CONTEXT = new byte[]{0x53, 0x69, 0x67, 0x6E, 0x61, 0x74, 0x75, 0x72, 0x65, 0x31}; // Signature1
	  ENCRYPT_CONTEXT = new byte[]{0x45, 0x6E, 0x63, 0x72, 0x79, 0x70, 0x74}; // Encrypt
	  //Empty strings
	  EMPTY_MAC_KEY =  new byte[]{0x45, 0x6d, 0x70, 0x74, 0x79, 0x20, 0x4d, 0x41, 0x43, 0x20, 0x6b, 0x65, 0x79}; // "Empty MAC key"
	  ...
	  MAC_DERIVE_KEY_CTX = new byte[]{0x4B, 0x65, 0x79, 0x20, 0x74, 0x6F, 0x20, 0x4D, 0x41, 0x43, 0x20, 0x70, 0x75, 0x62, 0x6C, 0x69, 0x63,
	          0x20, 0x6B, 0x65, 0x79, 0x73}; // "Key to MAC public ke
