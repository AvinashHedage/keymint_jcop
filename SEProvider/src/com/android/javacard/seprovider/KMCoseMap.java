...
public abstract class KMCoseMap extends KMType {
  ...
  private static boolean compareAndSwap(short ptr, short index) {
    ...
    firstKeyLen = KMEncoder.getInstance().encode(firstKey, scratchpad, (short) 0);
    secondKeyLen = KMEncoder.getInstance().encode(secondKey, scratchpad, firstKeyLen);
