...
public class KMUtils {
  ...
  public static  byte[] oneSecMsec;
  public static  byte[] oneMinMsec;
  public static  byte[] oneHourMsec;
  public static  byte[] oneDayMsec;
  public static  byte[] oneMonthMsec;
  public static  byte[] leapYearMsec;
  public static  byte[] yearMsec;
  //Leap year(366) + 3 * 365
  public static  byte[] fourYrsMsec;
  public static  byte[] firstJan2020;
  public static  byte[] firstJan2051;
  // msec
  public static  byte[] febMonthLeapMSec;
  public static  byte[] febMonthMsec;
  public static  byte[] ThirtyOneDaysMonthMsec;
  public static  byte[] ThirtDaysMonthMsec;
